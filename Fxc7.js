...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Dapoy\n'
            + 'ORG:Owner FGX;\n'
            + 'TEL;type=CELL;type=VOICE;waid=62895639539898:+62 895-6395-39898\n'
            + 'END:VCARD'

prefix = "!"
name = "~ BOT DAPOY"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN DAPOY BOT😁"
rmenu = "HAI TEMEN DAPOY BOT👋 JANGAN LUPA DONASI YAA:)"
botinfo = "UNTUK INVITE BOT SILAHKAN DONASI DULU YAA:)"
limitt = 20
memberLimit = 2
ban = []
premium = ["62895639539898@s.whatsapp.net","6285762102148@s.whatsapp.net"]
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["62895639539898@s.whatsapp.net","6285762102148@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
         ...
         case 'lirik':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                    ...
                    client.sendMessage('62895639539898@s.whatsapp.net', options, text, {quoted: mek})
